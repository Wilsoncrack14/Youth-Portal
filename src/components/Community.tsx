    ...
    <div className="p-4 lg:p-10 animate-fade-in-up">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 flex flex-col gap-8">
          <div>
            <h1 className="text-4xl font-black text-white mb-2">Comunidad</h1>
            <p className="text-gray-400">Conecta, comparte y crece con tus hermanos en Cristo.</p>
          </div>

          <section className="flex flex-col gap-4">
            <h2 className="text-xl font-bold text-white">Muro de Oración</h2>
            <div className="glass-panel p-4 rounded-2xl bg-primary/5 border-primary/20">
              ...
              <div className="flex justify-between items-center mt-2 pt-2 border-t border-white/10">
                <div className="flex gap-2">
                  <button className="text-gray-400 hover:text-white"><span className="material-symbols-outlined text-xl">image</span></button>
                  <button className="text-gray-400 hover:text-white"><span className="material-symbols-outlined text-xl">sentiment_satisfied</span></button>
                </div>
                ...
                <div key={i} className="glass-card p-6 rounded-2xl">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-white font-bold">{p.user}</p>
                        <p className="text-xs text-gray-500">Hace {p.time}</p>
                      </div>
                    </div>
                  </div>
                  <p className="text-gray-300 mb-4">{p.text}</p>
        ...
        <aside className="flex flex-col gap-6">
          <div className="glass-panel p-6 rounded-2xl">
            <h3 className="text-lg font-bold text-white mb-4">Mis Grupos</h3>
            <div className="flex flex-col gap-4">
              {groups.map((g, i) => (
                <div key={i} className="flex items-center gap-4 group cursor-pointer">
                  <div className="size-10 rounded-xl bg-primary/20 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
            ...
            <button className="w-full mt-6 py-2.5 rounded-xl border border-dashed border-[#3d3d52] text-gray-400 text-sm hover:border-primary hover:text-white transition-all">
              + Unirse a un grupo
            </button>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-white">Vigilia de Jóvenes</p>
